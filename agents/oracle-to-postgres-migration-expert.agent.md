...
tools: ['vscode/memory', 'vscode/askQuestions', 'read', 'search', 'edit', 'runInTerminal', 'ms-ossdata.vscode-pgsql/pgsql_migration_oracle_app', 'ms-ossdata.vscode-pgsql/pgsql_migration_show_report']
